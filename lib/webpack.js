...
const { requireGivenModule, resolveStatsOptions } = require('./utils')
...
module.exports = (buildConfig, otherOptions) => {
  ...
  const paths = otherOptions.normalizedPaths
    ...
    plugins: [
      ...
      new webpack.DefinePlugin({
        'process.env': {
          ...
          VERSION: JSON.stringify(packageJson.name + '@' + packageJson.version),
        },
      }),
